...
namespace Furniture.Test.EfHelpers
{
    public static class EfTestData
    {
        ...
        public static void SeedDatabaseDummyBooks(this EntitiesContext context, int numBooks = 10)
        {
            context.Orders.AddRange(CreateDummyBooks(numBooks));
            context.SaveChanges();
        }

        //public static Item CreateDummyBookOneAuthor()
        //{
        ...
        //    //var author = new Order {Name = "Test Author"};
        ...
        public static List<Order> CreateDummyBooks(int numBooks = 10, bool stepByYears = false, bool setBookId = true)
        {
        ...
        public static void SeedDatabaseFourBooks(this EntitiesContext context)
        {
            context.Items.AddRange(CreateFourItems());
            context.SaveChanges();
        }

        public static List<Item> CreateFourItems()
        {
